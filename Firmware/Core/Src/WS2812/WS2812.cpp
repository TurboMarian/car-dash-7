...
void ConfigureDMA(void)
{
	...
	WS2812_PWM_DMA.Instance = DMA2_Stream1;
	WS2812_PWM_DMA.Init.Channel = DMA_CHANNEL_6;
	...
	WS2812_PWM_DMA.Init.PeriphDataAlignment = DMA_PDATAALIGN_HALFWORD;
	WS2812_PWM_DMA.Init.MemDataAlignment    = DMA_PDATAALIGN_HALFWORD;
