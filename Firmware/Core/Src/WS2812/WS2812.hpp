...
#define WS2812_LED_N    24 // Number of LEDs
...
#define WS2812_BUFLEN (WS2812_LED_N * 24) * 2 // * 2 if HALFWORD

#define WS2812_PWM_FREQUENCY (HAL_RCC_GetHCLKFreq() / 2)
#define WS2812_PWM_PERIOD (WS2812_PWM_FREQUENCY / 800000)

#define WS2812_DUTYCYCLE_0 (WS2812_PWM_PERIOD * 1.25 * 0.4)
#define WS2812_DUTYCYCLE_1 (WS2812_PWM_PERIOD * 1.25 * 0.8)
