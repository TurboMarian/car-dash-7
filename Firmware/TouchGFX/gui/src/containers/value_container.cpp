...
void value_container::initContainer(CONTAINER channel) {
	...
	container_background.setColor(
			touchgfx::Color::getColorFromRGB(channel.Background_Color.red,
					channel.Background_Color.green,
					channel.Background_Color.blue));
	...
	case ALIGN_LEFT:
		...
		container_value_L.setColor(
				touchgfx::Color::getColorFromRGB(channel.Value.Text_Color.red,
						channel.Value.Text_Color.green,
						channel.Value.Text_Color.blue));
	...
	switch (channel.Label.Alignment) {
	case ALIGN_LEFT:
		...
		container_label_L.setColor(
				touchgfx::Color::getColorFromRGB(channel.Label.Text_Color.red,
						channel.Label.Text_Color.green,
						channel.Label.Text_Color.blue));
	...
	case ALIGN_LEFT:
		...
		container_unit_L.setColor(
				touchgfx::Color::getColorFromRGB(channel.Unit.Text_Color.red,
						channel.Unit.Text_Color.green,
						channel.Unit.Text_Color.blue));
...
void value_container::updateContainer(CONTAINER channel) {
	Unicode::UnicodeChar buffer[32];
	...
	//-------------------------------VALUE-----------------------------------------
	//-----------------------------------------------------------------------------
	float value = ((channel.Data.Value * 1.0) / (channel.Data.Divider * 1.0))
